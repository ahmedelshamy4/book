...
public class AddBookActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {

    private Button btnBookDate, btnAddPdfFile, btnAddNewBook;
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            ...
                            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                                ...
                                if (photoFile != null) {
                                    Uri photoURI = FileProvider.getUriForFile(AddBookActivity.this, "com.eslamelhoseiny.bookstore.Fileprovider", photoFile);
    ...
    private void addNewBook() {
        ...
        book = new Book(bookId, title, description, price, date, btnAddPdfFile.getText().toString(), publisherId);
    ...
    private void uploadBookImage() {
        Uri photoURI = FileProvider.getUriForFile(AddBookActivity.this, "com.eslamelhoseiny.bookstore.Fileprovider", imageFile);
        FirebaseStorage.getInstance()
                .getReference()
