...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        publisher = (Publisher) getIntent().getSerializableExtra(ActivityLauncher.PUBLISHER_KEY);
    ...
    private void uploadUserProfileImage(String id) {
        ...
        Uri photoURI = FileProvider.getUriForFile(this,
                "com.eslamelhoseiny.bookstore.Fileprovider", imageFile);
                                    ...
                                    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                                        ...
                                        if (photoFile != null) {
                                            Uri photoURI = FileProvider.getUriForFile(EditProfileActivity.this,
                                                    "com.eslamelhoseiny.bookstore.Fileprovider", photoFile);
