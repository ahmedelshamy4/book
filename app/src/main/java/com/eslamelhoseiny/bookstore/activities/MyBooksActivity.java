...
import com.eslamelhoseiny.bookstore.adapter.BookAdapter;
import com.eslamelhoseiny.bookstore.data.Book;
import com.eslamelhoseiny.bookstore.data.Publisher;
import com.eslamelhoseiny.bookstore.fragment.BookDetailsFragment;
...
public class MyBooksActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, BookAdapter.OnBookClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityLauncher.openAddBookActivity(MyBooksActivity.this);
        ...
        BottomSheetBehavior.from(findViewById(R.id.fragment_book_details));
                    ...
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (publisher != null) {
                                ...
                                Picasso.with(MyBooksActivity.this)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Toast.makeText(MyBooksActivity.this, "Done", Toast.LENGTH_SHORT).show();
                return false;
            }
...
//                .beginTransaction()
//                .replace(R.id.fragment_book_details, BookDetailsFragment.with(book))
//                .addToBackStack(null)
//                .commit();
    ...
    public void editBook(Book book) {
        ActivityLauncher.openEditBookActivity(this, book);
        searchMenuItem.collapseActionView();
    }

    @Override
    public void onClick(View v) {
        ActivityLauncher.openEditPublisherActivity(this, publisher);
    }
}
